...
# rospy.Subscriber('motor/front/left', Int16 ,motor2)
# rospy.Subscriber('motor/front/right', Int16, motor1)
# rospy.Subscriber('motor/rear/left', Int16, motor4)
# rospy.Subscriber('motor/rear/right', Int16, motor3)
